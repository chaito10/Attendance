...
1. Download the archive from the
   ...
   ```bash
   curl -L -o attendance-v0.3.1-linux-x86_64.tar.gz \
     https://github.com/chaito10/Attendance/releases/download/v0.3.1/attendance-v0.3.1-linux-x86_64.tar.gz
   ```
...
```bash
sha256sum attendance-v0.3.1-linux-x86_64.tar.gz
```
