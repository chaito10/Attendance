...
1. Download
   [`attendance-v0.3.1-win64.zip`](https://github.com/chaito10/Attendance/releases/download/v0.3.1/attendance-v0.3.1-win64.zip)
...
The official SHA-256 of `attendance-v0.3.1-win64.zip` is published with each
[release](https://github.com/chaito10/Attendance/releases/latest). Verify it
for yourself:

```powershell
Get-FileHash .\attendance-v0.3.1-win64.zip -Algorithm SHA256
```
